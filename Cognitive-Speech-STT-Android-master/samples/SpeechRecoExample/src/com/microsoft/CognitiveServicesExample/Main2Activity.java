...
public class Main2Activity extends Activity implements ISpeechRecognitionServerEvents {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //newMessage = message;
        this._logText = (EditText) findViewById(R.id.editText);
        this._buttonSelectMode = (Button)findViewById(R.id.button3);
        this._startButton = (Button) findViewById(R.id.button);
